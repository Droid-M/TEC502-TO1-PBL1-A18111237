...
raspberry_ip = '192.168.0.106'
raspberry_username = 'marcos'
raspberry_password = 'droid'
...
command = 'cd Documentos/GitHub/test web socket/ && python3 server.py'
...
try:
    ...
    stdin, stdout, stderr = ssh_client.exec_command("konsole -e python3 Documentos/GitHub/'test web socket'/server.py")
